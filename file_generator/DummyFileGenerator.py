...
class FileWriterConfig:
    ...
    Configuration for file writing.
      ...
      semaphore_ext : str - The name of the semaphore file used to 
...
class DummyFileGenerator:
    ...
    def __init__(self,
                 ...
                 logfile = None):
        sys.path.append(os.path.join(os.path.dirname(os.path.abspath(__file__)), "../uploader/"))
        from uploader import MakeLogger
    ...
    def generate_file(self):
        ...
        _outfile_path = os.path.join( self.file_writer_config.output_dir,
                                      f"{self.file_prefix}_{_fnum_str}.dat")
        ...
        if os.path.exists(_outfile_path):
            ...
            _outfile_path = os.path.join( self.file_writer_config.output_dir,
                                         f"{self.file_prefix}_dupl_{_fnum_str}.dat")
        ...
        if self.file_writer_config.semaphore_ext:
            _semaphore_path = _outfile_path + self.file_writer_config.semaphore_ext
    ...
    def write_files(self):
        ...
        try:
            ...
            self.logger.info("File generation interrupted by keyboard interrupt.")